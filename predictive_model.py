...
sgd_clf.fit(titanic_dataset_train_Column, titanic_train_segment)
...
cross_val_score(sgd_clf, titanic_dataset_train_Column, titanic_train_segment, cv=3, scoring="accuracy")

#matriz de consfusão
from sklearn.model_selection import cross_val_predict
from sklearn.metrics import confusion_matrix 

y_train_pred = cross_val_predict(sgd_clf, titanic_dataset_train_Column, titanic_train_segment, cv=3)
confusion_matrix(titanic_train_segment,y_train_pred)

#controle de precisão
from sklearn.metrics import precision_score, recall_score
precision_score(titanic_train_segment, y_train_pred)